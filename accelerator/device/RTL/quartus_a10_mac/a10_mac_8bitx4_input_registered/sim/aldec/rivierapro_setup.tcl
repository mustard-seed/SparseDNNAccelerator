...
# ACDS 17.1.1 273 linux 2020.01.16.10:07:55
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     a10_mac_8bitx4_input_registered.a10_mac_8bitx4_input_registered
# 
...
# ----------------------------------------
# If a10_mac_8bitx4_input_registered.a10_mac_8bitx4_input_registered is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "a10_mac_8bitx4_input_registered.a10_mac_8bitx4_input_registered"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/jamesliu/intelFPGA_pro/17.1/quartus/"
}
...
ensure_lib                                 ./libraries/altera_mult_add_171            
vmap       altera_mult_add_171             ./libraries/altera_mult_add_171            
ensure_lib                                 ./libraries/a10_mac_8bitx4_input_registered
vmap       a10_mac_8bitx4_input_registered ./libraries/a10_mac_8bitx4_input_registered
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_mult_add_171/sim/a10_mac_8bitx4_input_registered_altera_mult_add_171_i4fixgy.v" -work altera_mult_add_171            
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/a10_mac_8bitx4_input_registered.v"                                                        -work a10_mac_8bitx4_input_registered
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_mult_add_171 -L a10_mac_8bitx4_input_registered -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_mult_add_171 -L a10_mac_8bitx4_input_registered -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
