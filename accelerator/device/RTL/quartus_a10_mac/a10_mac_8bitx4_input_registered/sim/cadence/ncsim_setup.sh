...
TOP_LEVEL_NAME="a10_mac_8bitx4_input_registered.a10_mac_8bitx4_input_registered"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/jamesliu/intelFPGA_pro/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/altera_mult_add_171/
mkdir -p ./libraries/a10_mac_8bitx4_input_registered/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_mult_add_171/sim/a10_mac_8bitx4_input_registered_altera_mult_add_171_i4fixgy.v" -work altera_mult_add_171             -cdslib ./cds_libs/altera_mult_add_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/a10_mac_8bitx4_input_registered.v"                                                        -work a10_mac_8bitx4_input_registered                                               
fi
