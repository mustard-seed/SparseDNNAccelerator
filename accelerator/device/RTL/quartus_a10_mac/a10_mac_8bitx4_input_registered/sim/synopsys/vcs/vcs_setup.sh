...
TOP_LEVEL_NAME="a10_mac_8bitx4_input_registered"
QSYS_SIMDIR="./../../"
...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/../altera_mult_add_171/sim/a10_mac_8bitx4_input_registered_altera_mult_add_171_i4fixgy.v \
  $QSYS_SIMDIR/a10_mac_8bitx4_input_registered.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
