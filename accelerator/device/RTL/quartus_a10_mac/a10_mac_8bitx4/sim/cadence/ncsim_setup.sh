...
TOP_LEVEL_NAME="a10_mac_8bitx4.a10_mac_8bitx4"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/a10_mac_8bitx4/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_mult_add_171/sim/a10_mac_8bitx4_altera_mult_add_171_ixw6vsi.v" -work altera_mult_add_171 -cdslib ./cds_libs/altera_mult_add_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/a10_mac_8bitx4.v"                                                        -work a10_mac_8bitx4                                                    
fi
