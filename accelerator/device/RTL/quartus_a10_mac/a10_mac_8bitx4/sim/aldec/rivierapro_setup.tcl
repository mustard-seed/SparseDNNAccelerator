...
# ACDS 17.1.1 273 linux 2019.07.08.14:50:53
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     a10_mac_8bitx4.a10_mac_8bitx4
# 
...
# ----------------------------------------
# If a10_mac_8bitx4.a10_mac_8bitx4 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "a10_mac_8bitx4.a10_mac_8bitx4"
}
...
ensure_lib                     ./libraries/a10_mac_8bitx4     
vmap       a10_mac_8bitx4      ./libraries/a10_mac_8bitx4     
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_mult_add_171/sim/a10_mac_8bitx4_altera_mult_add_171_ixw6vsi.v" -work altera_mult_add_171
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/a10_mac_8bitx4.v"                                                        -work a10_mac_8bitx4     
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_mult_add_171 -L a10_mac_8bitx4 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_mult_add_171 -L a10_mac_8bitx4 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
