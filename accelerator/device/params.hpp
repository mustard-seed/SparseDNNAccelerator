...
#define ACTIVATION_BURST_SIZE_BYTE_OFFSET (ACTIVATION_WIDE_SIZE_OFFSET + PE_SIMD_SIZE_CLUSTER_OFFSET + VALUE_TO_CLUSTER_SHIFT)
#else
#define ACTIVATION_BURST_SIZE_BYTE (ACTIVATION_WIDE_SIZE * PE_SIMD_SIZE * PRUNE_RANGE_IN_CLUSTER * CLUSTER_SIZE)
#define ACTIVATION_BURST_SIZE_BYTE_OFFSET (ACTIVATION_WIDE_SIZE_OFFSET + PE_SIMD_SIZE_CLUSTER_OFFSET + PRUNE_RNAGE_IN_CLUSTER_OFFSET + VALUE_TO_CLUSTER_SHIFT)
#endif
