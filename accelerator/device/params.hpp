...
#define TRANSFER_SIZE 4 //transfer block size in terms of clusters
#define CLUSTER_TO_TRANSFER_SIZE_SHIFT 0X2
#define CLUSTER_TO_TRANSEFER_SIZE_REMAINDER 0X3
...
#define CLUSTER_TO_TRANSFER_BLOCK_SHIFT 0x2 //amount of right shift required to convert a cluster count into transfer block count
...
#define BITMASK_ACCUM_COUNT_BITWIDTH 3 //$rtoi($clog2(MAX_NUM_OUTPUT) + 1.0)
#define BITMASK_INDEX_BITWIDTH 4 //$rtoi($ceil($clog2(COMPRESSION_WINDOW_SIZE)))
#define NUM_BITMASK_BYTES 2
#define NUM_ACCUM_BITMASK_BYTES 6
